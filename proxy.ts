...
export const config = {
  matcher: [
    ...
    // - /pitch y sus alias cortos (/lebane, /cromodata): piezas privadas por empresa,
    //   mismo caso que /stats: viven fuera de `[locale]` y sin esta exclusión
    //   darían 404
    ...
    "/((?!api|trpc|_next|_vercel|stats|pitch|lebane|cromodata|rl|.*\\..*).*)",
