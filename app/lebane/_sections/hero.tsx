  ...
  return (
    ...
    >
      <div className="grid items-end gap-10 md:grid-cols-[1.4fr_1fr] md:gap-8">
        <h1 className="hero-copy font-(family-name:--font-serif-optional) text-4xl leading-[1.08] font-semibold tracking-tight text-balance sm:text-5xl md:text-6xl lg:text-7xl">
