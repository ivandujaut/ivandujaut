  ...
  return (
    <div className="group relative my-6">
      ...
      <AnimateIcon animateOnHover asChild>
        ...
        >
          {/* El check se dibuja solo al aparecer (`animate`): confirma la copia
              sin depender del color, que es el único feedback que teníamos. */}
          {copied ? (
            <Check size={16} strokeWidth={1.5} animate aria-hidden />
          ) : (
