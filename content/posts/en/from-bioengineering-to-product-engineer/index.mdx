...
Today my week is split across three tables. The first is the product I'm working on right now, a real estate platform for the US market. The second is my Digital Techniques classes at IPSAJ, my old high school in Posadas, in front of 16-year-old students. The third is side cases: real problems from companies or people that I look at to see if I can build tools that help them.
