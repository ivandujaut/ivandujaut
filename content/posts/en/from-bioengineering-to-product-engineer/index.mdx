...
description: "How I became a Product Engineer coming from bioengineering, not Computer Science. What the role does in practice, and what I learned in four years without the official manual."
date: 2026-05-11
tags:
  - career
  - product-engineering
...
This morning, before nine o'clock, I already had VS Code open, a Supabase console, and an Excel file in its twenty-something version called FIJI Calcs v3.23b.xlsx. What I'm building is a product that validates real estate brokerages in the United States. The job is translating that spreadsheet into a system that supports buying and selling decisions worth millions of dollars. Every cell with a formula is a product decision I need to understand before writing a single line of code.
...
It's what people ask me most when I say the title, and the honest answer is that there is no official definition. Every company uses it differently. What I can describe is what it meant on the teams where I worked.

The role stands on both sides of the same decision: what gets built and how it gets built. When those two sides live in different people, context leaks in the handoff. Whoever defines the problem doesn't see the technical cost of their cut, and whoever implements it doesn't see why the cut was made that way. The role exists so that handoff isn't needed.

The spreadsheet I opened this post with works as an example. I could translate every formula into code and call the job done. The real work is understanding why that cell applies the adjustment it applies, who chose that criterion, and what happens to the valuation if the user moves it. That gets resolved by asking whoever built the spreadsheet, who knows things about brokerages I never will.

That's where the uncomfortable parts come from. Pushing back on whoever requested the feature. Shipping less than you proposed when half of it helps nobody. Getting into someone else's domain, insurance, real estate, collections, enough to hold your own opinion, without pretending to replace the person who is actually the expert.

The boundary is worth naming, because the title invites confusion. A Product Manager does market discovery, runs a quarterly roadmap and negotiates with stakeholders I never see. None of that is in my job. My radius is the product in front of me and the decisions that touch it closely.
...
The most expensive part of those first six months was realizing that I was fighting an identity I had imposed on myself. "I'm an engineer, I have to be able to learn this on my own." Hours and hours in front of the computer, without asking for help, back when AI couldn't help you out. Imposter syndrome grew because tasks kept piling up and I kept refusing to ask. Burnout, fear of looking foolish, all of it. And the most absurd part is that my original goal had never been to become the best developer on the team. My goal was to understand how a technical team worked so that one day I could lead one. But my mind was working against me, pushing me to become an expert at things that didn't matter.

The click came from a conversation with my tech lead. I was delivering late because I kept expanding use cases on my own, based on my own hypotheses, not on real user problems. He explained something simple that changed the way I work: done is better than perfect. I was inverting Pareto. Instead of 20% effort for 80% of the result, I was spending 80% to get an extra 20% that no one had asked for. And that slowed the whole team down.
...
In those projects, I discovered something that now seems obvious to me: clients never come asking for a feature. They come with a pain, a manual process that eats up their hours, a bottleneck they don't know how to fix. The feature is the translation we make of that pain. And for that translation to be good, someone on the team needs to have a view of the whole product, beyond their role. That was the place I started to fill. It is the same exercise I run when I analyse someone else's product: in [the premium that never arrives](/en/projects/cobranza-seguros) the request would be "improve the payment reminder", and the pain sits three steps earlier.

At the team level, what I learned was similar. When I joined, the team was closing sprints at 60% predictability. By the time I left the role, we were at 90%. We identified where tickets piled up at the end of the sprint, rethought refinement by prioritizing flows over isolated tasks, and switched from code-then-test to testing in parallel. What made the difference was understanding the whole system and pulling the right lever.
...
I understood that my role had changed while redesigning an onboarding.
...
The side cases are the third side of the triangle. The latest thing that caught my attention was seeing how a hospital in my hometown still manages staff scheduling and medical equipment tracking with manual processes. It's almost symmetric to what I do today, translating Excel into a system, but in a domain I know from bioengineering. For now it is a conversation, nothing more. The logic I follow is the same as always: understand the pain first, see if it can be eased with technology, and decide whether it's worth building. If it goes through, everyone wins. If not, I keep it as a learning.

Being honest, what I lack the most is communication. My English still isn't at the level I want for long meetings with international teams, and sometimes that makes me hesitate at moments when I'd have something to contribute. I'm building my leadership soft skills in parallel, but I still feel more comfortable being the one who executes than the one who decides for others. And public visibility I just don't have: until recently my only channel was LinkedIn and one-on-one conversations. This blog is part of changing that. The idea is to document the journey while it's happening.
